...
def dos_menu():
	...
	print(f"""
		    ...
		    {BLUE}╚{RED}██{BLUE}╗ {RED}██{BLUE}╔╝{RED}██{BLUE}╔══{RED}██{BLUE}╗{RED}████{BLUE}╗  {RED}██{BLUE}║{RED}██{BLUE}╔══{RED}██{BLUE}╗{RED}██{BLUE}╔════╝{RED}██{BLUE}╔══{RED}██{BLUE}╗{RED}██{BLUE}╔════╝
		     {BLUE}╚{RED}████{BLUE}╔╝ {RED}███████{BLUE}║{RED}██{BLUE}╔{RED}██{BLUE}╗ {RED}██{BLUE}║{RED}██{BLUE}║  {RED}██{BLUE}║{RED}█████{BLUE}╗  {RED}██████{BLUE}╔╝{RED}█████{BLUE}╗  
		      {BLUE}╚{RED}██{BLUE}╔╝  {RED}██{BLUE}╔══{RED}██{BLUE}║{RED}██{BLUE}║╚{RED}██{BLUE}╗{RED}██{BLUE}║{RED}██{BLUE}║  {RED}██{BLUE}║{RED}██{BLUE}╔══╝  {RED}██{BLUE}╔══{RED}██{BLUE}╗{RED}██{BLUE}╔══╝  
		       {RED}██{BLUE}║   {RED}██{BLUE}║  {RED}██{BLUE}║{RED}██{BLUE}║ ╚{RED}████{BLUE}║{RED}██████{BLUE}╔╝{RED}███████{BLUE}╗{RED}██{BLUE}║  {RED}██{BLUE}║{RED}███████{BLUE}╗
		       {BLUE}╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝╚═════╝ ╚══════╝╚═╝  ╚═╝╚══════╝
""")
	print(f"			             {WHITE}[{RED}+{WHITE}] {RED}I'll Kill You Senpai {WHITE}[{RED}+{WHITE}]")
	print(f"""
	    {GREEN}╔════════════════════════╗{GREEN}╔════════════════════════╗{GREEN}╔════════════════════════╗
	    {GREEN}║{BLUE}      •    UDP   •      {GREEN}║{GREEN}║{BLUE}      •   HTTP   •      {GREEN}║{GREEN}║{BLUE}      • LDAP3  •        {GREEN}║
	    {GREEN}║{BLUE}      •   LDAP   •      {GREEN}║{GREEN}║{BLUE}      • HTTPTOMP •      {GREEN}║{GREEN}║{BLUE}      • OVHTCP •        {GREEN}║
	    {GREEN}║{BLUE}      •  TCPMUX  •      {GREEN}║{GREEN}║{BLUE}      •  OVH443  •      {GREEN}║{GREEN}║{BLUE}      • NFOTCP •        {GREEN}║
	    {GREEN}║{BLUE}      •  UDPRAW  •      {GREEN}║{GREEN}║{BLUE}      •  OVHSSH  •      {GREEN}║{GREEN}║{BLUE}      • TCPHEX •        {GREEN}║
	    {GREEN}║{BLUE}      •  UDPMIX  •      {GREEN}║{GREEN}║{BLUE}      •  OVHNFO  •      {GREEN}║{GREEN}║{BLUE}      • UDPHEX •        {GREEN}║
	    {GREEN}║{BLUE}      •  TCPRAND •      {GREEN}║{GREEN}║{BLUE}      •  SERVER  •      {GREEN}║{GREEN}║{BLUE}      • STDHEX •        {GREEN}║
	    {GREEN}╚════════════════════════╝{GREEN}╚════════════════════════╝{GREEN}╚════════════════════════╝
	    {GREEN}╔════════════════════════╗{GREEN}╔════════════════════════╗{GREEN}╔════════════════════════╗
	    {GREEN}║{BLUE}      • WEBCRASH •      {GREEN}║{GREEN}║{BLUE}      • NFOKILL •       {GREEN}║{GREEN}║{BLUE}      • SOFTOVH •       {GREEN}║
	    {GREEN}║{BLUE}      • SERVER2  •      {GREEN}║{GREEN}║{BLUE}      • SSHKILL •       {GREEN}║{GREEN}║{BLUE}      • SERVER3 •       {GREEN}║
	    {GREEN}║{BLUE}      • BYPASS   •      {GREEN}║{GREEN}║{BLUE}      • OPENVPN •       {GREEN}║{GREEN}║{BLUE}      • NFODROP •       {GREEN}║
	    {GREEN}║{BLUE}      • UDPRAPE  •      {GREEN}║{GREEN}║{BLUE}      • BUFFER  •       {GREEN}║{GREEN}║{BLUE}      • NFOHEX  •       {GREEN}║
	    {GREEN}║{BLUE}      • PORTKILL •      {GREEN}║{GREEN}║{BLUE}      • KILLALL •       {GREEN}║{GREEN}║{BLUE}      • NFOFLAT •       {GREEN}║
	    {GREEN}║{BLUE}      • OVHDEATH •      {GREEN}║{GREEN}║{BLUE}      • OVHKILL •       {GREEN}║{GREEN}║{BLUE}      • WITHER  •       {GREEN}║
	    {GREEN}╚════════════════════════╝{GREEN}╚════════════════════════╝{GREEN}╚════════════════════════╝
""")
	host = input(f'{CYAN}Enter Host{BLUE}:{CYAN} ')
	port = input(f'{CYAN}Enter Port{BLUE}:{CYAN} ')
	time = input(f'{CYAN}Enter Time{BLUE}:{CYAN} ')
	method = input(f'{CYAN}Method{BLUE}:{CYAN} ')
	print(f'Attack Sent to {host} | {port} | {time} | {method}')
	x = input(f'{CYAN}{BLUE}[{CYAN}Menu{BLUE}]{RED}-{BLUE}[{CYAN}Hub{BLUE}]:{CYAN} ')
	if x == 'menu' or 'Menu':
		dos_menu()
...
{BLUE}║  {BLUE}[{CYAN}5{BLUE}]{CYAN} Dos Menu          {BLUE}║
{BLUE}║                        {BLUE}║
{BLUE}╚════════════════════════╝
""")
